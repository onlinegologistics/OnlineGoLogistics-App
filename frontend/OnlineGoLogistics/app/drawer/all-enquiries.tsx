        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.container}>
          ...
          >
            ...
            <View style={{ flex: 1, marginLeft: 6 }}>
              ...
              <Text style={styles.headerSubtitle}>View status and replies to your enquiries.</Text>
            </View>
          </LinearGradient>
          ...
          {loading ? (
            ...
            <View style={styles.emptyCard}>
              <Ionicons name="chatbox-ellipses-outline" size={48} color={DARK_GLASS_THEME.textSecondary} />
              <Text style={styles.emptyText}>No enquiries submitted yet.</Text>
              <Pressable style={styles.createBtn} onPress={() => router.push("/drawer/enquiries")}>
                <Text style={styles.createBtnText}>Send New Enquiry</Text>
              </Pressable>
            </View>
          ) : (
            enquiries.map((item) => {
              ...
              return (
                <View key={item._id} style={styles.enquiryCard}>
                  <View style={styles.cardRow}>
                    <View style={styles.typeBadge}>
                      <Text style={styles.typeText}>{item.enquiryType}</Text>
                    </View>
